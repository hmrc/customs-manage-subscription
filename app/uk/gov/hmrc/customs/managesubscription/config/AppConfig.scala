...
class AppConfig @Inject()(config: Configuration, servicesConfig: ServicesConfig) {
  ...
  val emailRCMTemplateId: String = config.get[String]("microservice.services.email.rcmTemplateId")
  val rcmEmail: String = config.get[String]("microservice.services.email.rcmEmail")
