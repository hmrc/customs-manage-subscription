...
class RecipientDetailsStore @Inject()(repository: RecipientDetailsRepository) {
  ...
  def saveRecipientDetailsForBundleId(formBundleId: String, eori: Option[Eori], recipientDetails: RecipientDetails, emailVerificationTimestamp: String, safeId: String): Future[Boolean] = repository.saveRecipientDetailsForBundleId(formBundleId, eori, recipientDetails, emailVerificationTimestamp, safeId)
